...
public class QuestionSelect extends JPanel {// select the answer to the question
	/**
	 * This class makes the label and the combobox dropdown menu. The label contains
	 * the title to a coumn of the dmn rule table of a rule. The title is often a question
	 */
