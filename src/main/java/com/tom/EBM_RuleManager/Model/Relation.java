...
public class Relation implements Serializable {
	/**
	 * This Class Stores the rules that are related to a particular concept 
	 * This needs to be the same as the class in the protege plugin so that the
	 * serialized data is loaded properly
	 */
